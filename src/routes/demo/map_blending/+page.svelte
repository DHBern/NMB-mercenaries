...
<style>
	...
	:global(.animated-svg circle) {
		...
		r: calc(
			1px * calc(var(--full) * calc(2 * abs(abs(calc(max(0, min(1, calc(var(--state) - 0.5))) - 0.5)) - 0.5))) +
			1px * calc(var(--europe) * calc(2 * abs(abs(calc(max(0, min(1, calc(var(--state) - 1.5))) - 0.5)) - 0.5))) +
			1px * calc(var(--seasia) * calc(2 * abs(abs(calc(max(0, min(1, calc(var(--state) - 2.5))) - 0.5)) - 0.5))) +
			1px * calc(var(--java) * calc(2 * abs(abs(calc(max(0, min(1, calc(var(--state) - 3.5))) - 0.5)) - 0.5))) +
			1px * calc(var(--rivers) * calc(2 * abs(abs(calc(max(0, min(1, calc(var(--state) - 4.5))) - 0.5)) - 0.5)))
		);
